...
To create a Brevo connector, you need to provide the following information:

- login (your email address)
- API key

![Brevo connector credentials Myddleware form](images/credentials/sendinblue_connector_credentials.png)

#### Where to find your API key?

You can get your Brevo API key by going to the user menu, then go to ``SMTP & API`` or directly to https://app.brevo.com/settings/keys/api.
